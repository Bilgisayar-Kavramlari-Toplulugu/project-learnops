# Cloud and Devops Learning Platform (Örnek)
...
**Part of [Cloud and Devops Learning Platform](docs/Project-Definition.md)**
...
> **ÖNEMLİ:** Bu repository **Cloud and Devops Learning Platform** projesinin bir parçasıdır. Proje hakkında detaylı bilgi için [`docs/Project-Definition.md`](docs/Project-Definition.md) dosyasına bakın.
...
> **IMPORTANT:** This repository is part of **Cloud and Devops Learning Platform** project. See [`docs/Project-Definition.md`](docs/Project-Definition.md) for details.
