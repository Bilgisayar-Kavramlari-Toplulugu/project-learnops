...
const avatarToneClasses = [
  "bg-blue-100   text-blue-800   dark:bg-blue-900/55   dark:text-blue-100",
  ...
  "bg-red-100    text-red-800    dark:bg-red-900/55    dark:text-red-100",
  "bg-purple-100 text-purple-800 dark:bg-purple-900/55 dark:text-purple-100",
