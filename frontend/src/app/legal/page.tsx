...
export const metadata: Metadata = {
  ...
  description: "LearnOps kullanım koşulları, gizlilik politikası ve KVKK aydınlatma metni.",
};
          ...
          <div className="mb-8 flex flex-col gap-4 border-b border-slate-200 pb-8 dark:border-slate-800 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600 dark:text-slate-300">
                Bu sayfa LearnOps platformunu kullanırken geçerli olan kullanım koşullarını,
                gizlilik esaslarını ve KVKK kapsamında bilgilendirme metnini içerir.
              </p>
            </div>
          ...
          <div className="space-y-12">
            <section id="terms" className="scroll-mt-8 space-y-5">
              ...
              <LegalBlock title="2. Hesap oluşturma ve giriş">
                Platforma Google, GitHub veya LinkedIn gibi üçüncü taraf giriş sağlayıcılarıyla
                erişebilirsin. Giriş yaptığında hesabınla ilişkili temel profil bilgileri sistem
                tarafından işlenebilir.
              </LegalBlock>

              <LegalBlock title="3. Kullanıcı sorumlulukları">
                Platformu hukuka aykırı, kötüye kullanım oluşturacak, yanıltıcı veya başkalarının
                haklarını ihlal edecek şekilde kullanmamalısın. Hesabının güvenliğinden kullanıcı
                sorumludur.
              </LegalBlock>

              <LegalBlock title="4. Eğitim içerikleri">
                Platformdaki eğitim içerikleri öğrenme amacıyla sunulur. İçeriklerin belirli bir
                kariyer sonucu, sertifika veya mesleki başarı garantisi verdiği taahhüt edilmez.
              </LegalBlock>

              <LegalBlock title="5. Hizmet değişiklikleri">
                LearnOps; platform özelliklerini, kurs içeriklerini, quizleri, arayüzü veya erişim
                yapısını önceden bildirmeksizin güncelleyebilir, değiştirebilir veya kaldırabilir.
              </LegalBlock>

              <LegalBlock title="6. Hesap sonlandırma">
                Kullanıcı hesabını kapatma veya sildirme talebinde bulunabilir. Teknik, hukuki veya
                güvenlik gereklilikleri kapsamında bazı kayıtlar sınırlı süreyle saklanabilir.
              </LegalBlock>
            </section>
            ...
            >
              ...
              <LegalBlock title="1. İşlenen veriler">
                ...
                kurslar, oturum kayıtları, IP adresi ve temel teknik log kayıtları işlenebilir.
              </LegalBlock>

              <LegalBlock title="2. Verilerin işlenme amaçları">
                Kişisel veriler; kullanıcı hesabı oluşturma, güvenli giriş sağlama, kurs
                ilerlemesini takip etme, quiz sonuçlarını gösterme, sistem güvenliğini sağlama, hata
                ayıklama ve platform deneyimini geliştirme amaçlarıyla işlenir.
              </LegalBlock>

              <LegalBlock title="3. Hukuki sebep">
                Veriler; hizmetin sunulabilmesi, sözleşmenin kurulması veya ifası, veri sorumlusunun
                meşru menfaati ve ilgili mevzuat kapsamındaki yükümlülüklerin yerine getirilmesi
                hukuki sebeplerine dayanılarak işlenebilir.
              </LegalBlock>

              <LegalBlock title="4. Üçüncü taraf giriş servisleri">
                Google, GitHub veya LinkedIn ile giriş yapılması halinde ilgili sağlayıcıların
                ilettiği temel kullanıcı bilgileri kullanılabilir. Bu servislerin kendi gizlilik
                politikaları ayrıca geçerlidir.
              </LegalBlock>

              <LegalBlock title="5. Verilerin paylaşılması">
                Kişisel veriler; yalnızca barındırma, kimlik doğrulama, veritabanı, güvenlik ve
                teknik altyapı hizmetlerinin sağlanması amacıyla hizmet alınan üçüncü taraf servis
                sağlayıcılarla sınırlı olarak paylaşılabilir.
              </LegalBlock>

              <LegalBlock title="6. Saklama süresi">
                Veriler hesabın aktif olduğu süre boyunca ve hizmetin güvenli, sürdürülebilir
                şekilde çalışması için gerekli makul süre boyunca saklanabilir. Hesap silme
                taleplerinde veriler uygun ölçüde silinir, anonimleştirilir veya erişime kapatılır.
              </LegalBlock>

              <LegalBlock title="7. Çerezler ve oturum yönetimi">
                Platform; kullanıcı oturumlarının yönetimi, güvenli giriş ve temel kullanıcı
                deneyimi için gerekli çerezleri veya benzer teknolojileri kullanabilir.
              </LegalBlock>

              <LegalBlock title="8. KVKK kapsamındaki haklar">
                KVKK kapsamında kişisel verilerinin işlenip işlenmediğini öğrenme, işlenmişse bilgi
                talep etme, düzeltilmesini isteme, silinmesini talep etme ve ilgili mevzuatta yer
                alan diğer haklarını kullanma hakkına sahipsin.
              </LegalBlock>
