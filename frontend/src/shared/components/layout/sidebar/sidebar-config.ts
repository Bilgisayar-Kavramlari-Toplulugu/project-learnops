...
export interface SidebarTemplateLink {
  label: string;
  description: string;
  href: string;
  icon: LucideIcon;
...
export const sidebarTemplateLinks: SidebarTemplateLink[] = [
  {
...
export const sidebarSystemNotes: SidebarSystemNote[] = [
  ...
  },
  {
    ...
    value: "Template",
    toneClass:
      "text-amber-700 bg-amber-50 border-amber-100 dark:text-amber-300 dark:bg-amber-900/25 dark:border-amber-900/60",
  },
  {
    label: "API Mode",
    value: "Mock/Live",
